...
from pneumonia_classifier.configuration.s3_operations import S3Operation
from pneumonia_classifier.entity.artifacts_entity import DataIngestionArtifact
from pneumonia_classifier.entity.config_entity import DataIngestionConfig
